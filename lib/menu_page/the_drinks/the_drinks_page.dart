...
import 'package:Menyu/menu_page/the_drinks/detalis_page.dart';
...
class TheDrinksPaga extends StatefulWidget {
  TheDrinksPaga({Key? key}) : super(key: key);

  @override
  State<TheDrinksPaga> createState() => _TheDrinksPagaState();
}

class _TheDrinksPagaState extends State<TheDrinksPaga> {
        ...
        builder: (context, data, child) {
          return SafeArea(
            child: (langProvider.getItemSelected())
                ? Detailspage5(_selectedItemIndex)
                : Scaffold(
              body: LayoutBuilder(
                builder:
