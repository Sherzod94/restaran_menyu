...
import 'package:Menyu/menu_page/dishes2/detalis_page2.dart';
...
class DishesPage2 extends StatefulWidget {
  DishesPage2({Key? key}) : super(key: key);

  @override
  State<DishesPage2> createState() => _DishesPage2State();
}

class _DishesPage2State extends State<DishesPage2> {
        ...
        builder: (context, data, child) {
          return SafeArea(
            child: (langProvider.getItemSelected())
                ? Detailspage1(_selectedItemIndex)
                : Scaffold(
                    body: LayoutBuilder(
                      builder:
  ...
  Widget meal(Meal1 meal, context, index) {
    return Stack(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                final langProvider = Provider.of<LongProvider>(
                                    context,
                                    listen: false);
